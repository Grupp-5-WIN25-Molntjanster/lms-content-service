...
namespace Lms.ContentService.Infrastructure.Middleware;
...
public class ApiKeyMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        if (context.Request.Path.StartsWithSegments("/api/internal"))
        {
            ...
            var expectedApiKey = context.RequestServices.GetRequiredService<IConfiguration>()["InternalApiKeys:ContentService"];
